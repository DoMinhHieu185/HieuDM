...
### Section 29.1: Simple completion using function(Lập trình đơn giản sử dụng funtion)
```
_mycompletion() {
...
### Section 29.2: Simple completion for options and filenames(lập trình đơn giản cho các tuỳ chọn và tên tệp)
```
